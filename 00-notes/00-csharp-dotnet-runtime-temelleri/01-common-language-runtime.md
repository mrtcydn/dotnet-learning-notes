...
- C#'da derleme yapıldığında gerçek bir makine kodu oluşmaz. Derleyici **'Roslyn'** bir ara dile çevirir. Buna **[IL](02-intermediate-language.md)** denir. 
---
## Diyagram
...
- CLR gönderilir
- [JIT](03-just-in-time-compiler.md) IL kodunu makine koduna çevirir
- CPU çalıştırır
---
## CLR Neleri Yönetir?
